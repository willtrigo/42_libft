...
/*   Updated: 2024/03/17 04:09:27 by dande-je         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_cast_hex_ptr(va_list ap, t_line *line, t_line *format, \
			int spec)
{
	t_ulli			hex;
...
static void	ft_cast_hex_lw_up_aux(t_line *line, \
				t_hex_status *hex_status, const t_ulli hex, int spec)
{
	if (spec == CHK_HEX_LW)
